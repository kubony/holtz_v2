...
st.set_page_config(page_title="그집밥 서울창업허브점 챗봇", page_icon="📚")
st.header('그집밥 서울창업허브점 챗봇')
...
class ProjectContextChatbot:
    ...
    def load_project_context(self):
        try:
            file_path = os.path.join("store_infos", "서울창업허브 3층 그집밥.md")
    ...
    def main(self):
        ...
        user_query = st.chat_input(placeholder="그집밥 서울창업허브점입니다! 주문하시겠어요?")
